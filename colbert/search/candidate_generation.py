    ...
    def generate_candidates(self, config, Q):
        ...
        try:
            ...
            def process_in_chunks(tensor, chunk_size):
                ...
                unique_chunks = [torch.unique_consecutive(chunk, return_counts=True) for chunk in chunks]
                return unique_chunks
            chunk_size = 50000000  # Adjust based on what is feasible for your setup
            pids, pids_counts = process_in_chunks(pids, chunk_size)
        if self.use_gpu:
